document.addEventListener('DOMContentLoaded', () => {
    ...
    window.openEditModal = function(idFirma, nombre, imagenUrl, estado) {
        resetStyles(editNombre);

        if (editForm) {
            // CORREGIDO: Se cambia el prefijo a 'entidades_crud'
            editForm.action = '/coordinador/entidades_crud/firma/' + idFirma; 
        }
        ...
        // Gestiona la previsualización de la firma guardada anteriormente
    ...
    window.openDeleteModal = function(idFirma, nombre) {
        if (deleteForm) {
            // CORREGIDO: Se cambia el prefijo a 'entidades_crud'
            deleteForm.action = '/coordinador/entidades_crud/firma/' + idFirma; 
        }
    ...
    // Regla de validación visual para el nombre del firmante
    ...
    const searchInput = document.getElementById('search-firma');
